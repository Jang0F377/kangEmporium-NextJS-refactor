  ...
  return (
    <div className="font-inter">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 ">
        <div className="relative bg-white shadow-xl rounded-tr rounded-br">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden py-10 px-6 bg-dodger-blue-dark sm:px-10 xl:p-12 rounded-tl rounded-bl">
              ...
              <p className="mt-6 text-base text-white max-w-3xl">
                Koach Kang&apos;s Emporium - better items, better prices. Please
                give us a call or shoot us a message, we&apos;d love to hear
                from you.
              </p>
